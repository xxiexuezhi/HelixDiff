    ...
    with torch.no_grad():
      ...
      if condition is not None:
        for k,v in condition.items():
          if k == "length":
          ...
          elif k == "inpainting":# this part is updated again on May25 for helixsgm inpaint work.
            ...
            # this is what I changed for the seq masking. 
            #for l in range(len(conditional_mask)):
            #    conditional_mask[l,4] = v["seq_mask"][l] 
