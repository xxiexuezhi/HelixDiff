...
target_coords_NC = np.array([[164.818, 152.109, 124.646],
       [172.104, 151.534, 129.121],
       [172.321, 150.126, 128.602],
       [173.736, 149.683, 128.761],
       [174.616, 149.756, 127.699],
       [174.076, 153.69 , 126.715],
       [173.66 , 152.597, 124.519],
       [173.281, 152.723, 123.077],
       [177.193, 153.816, 130.896],
       [178.687, 151.919, 129.786],
       [179.275, 151.647, 131.144],
       [177.57 , 155.324, 136.386]], dtype="float32")
# change L type hotspots to D type
target_coords_NC = target_coords_NC * -1
#####target_atom_name = target_atom_names[kkk]
target_atom_name =['CA_PHE_28',
 'CB_PHE_28',
 'CG_PHE_28',
 'CD2_PHE_28',
 'CA_ILE_29',
...
#    assert not (args.pdb is not None and args.select_length)
    ...
    workdir = Path("sampling", "case_study_glp1_helix3", Path(args.config).stem, Path(args.checkpoint).stem, args.tag)
